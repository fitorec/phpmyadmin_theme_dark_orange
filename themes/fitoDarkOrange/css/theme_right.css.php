...
.hover {
    background: #FFC883;
    color: #666; <?php /* echo $GLOBALS['cfg']['BrowsePointerColor']; */ ?>
}
...
table label:hover{
	text-shadow: 1px 1px 0 #fff, -1px -1px 0 #FCCB8E, 1px 1px 5px #FF2B00;
}
/**
...
td .icon:hover,table tr.odd td .icon:hover {
    background: #fabc6f;
	border-left: 1px solid #F9A15E;
    border-top: 1px solid #F9A15E;
...
ul#topmenu li a:hover {
	color: black;
	background: #FF4400;
	background: -moz-linear-gradient(100% 100% 90deg, #ff2e00, #ff5f00);
	background: -webkit-gradient(linear, 0% 0%, 0% 100%, from(#ff2e00), to(#ff5f00));
	text-shadow: #961B00 -1px -1px 10px, #FFFAEE -1px -1px 0px,#961B00 1px 1px 10px, #FFFAEE 1px 1px 0px;
}
...
#topmenucontainer{
	background:url(./themes/fitoDarkOrange/img/tab_bg.png) repeat-x;
}
/* default tab styles */
.tabactive {
	color: white !important;
	background: -moz-linear-gradient(100% 100% 90deg, #033268, #0064AB) !important;
	background: -webkit-gradient(linear, 0% 0%, 0% 100%, from(#033268), to(#0064AB)) !important;
	text-shadow: #000 -1px -1px 10px, #002564 -1px -1px 0px,#002564 1px 1px 10px, #000 1px 1px 0px !important;
}
.tab, .tabcaution, .tabactive {
    display:            block;
    padding:10px 20px 9px 10px;
    white-space:        nowrap;
    background: url("./themes/fitoDarkOrange/img/tab_bg.png") repeat-x scroll 0 0 transparent
...
thead th{
	...
	background: #111;
	background: -moz-linear-gradient(100% 100% 90deg, #111111, #333333);
...
/* main page */
#maincontainer {
/*    background: url(./themes/fitoDarkOrange/img/body_bg.png) repeat-x;*/
...
.group:hover, .data:hover{
	background: #DFEFFF;
	-moz-box-shadow: 1px 1px 0 #444, 3px 3px 10px #0066BB, -1px -1px 0 #444, -3px -3px 10px #0066BB;
	border:1px solid #D1D1D1;
    -moz-border-radius:4px;
    -webkit-border-radius:4px;
}
.data{
	-moz-box-shadow: 1px 1px 0 #222, 3px 3px 10px #57738A, -1px -1px 0 #222, -3px -3px 10px #57738A;
...
.group:hover h2{
	...
	color: #FFF;
	text-shadow: 1px 1px 0 #000, 0 0 15px #00DAFF;
}
.group h2 {
    ...
    font-size:2em;
    font-weight:normal;
    text-shadow: 1px 2px 2px #000 ,-1px -2px 2px #444;
}
